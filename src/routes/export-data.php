...
Route::group(['middleware' => ['web', 'auth'], 'guard' => 'auth'], function () {
    ...
    Route::post('/plugins/export-data/export-specific-data', [\mbakgor\ExportData\Http\Controllers\ExportDataController::class, 'exportDisks'])->name('export-data.exportSpecificData');
