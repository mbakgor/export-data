                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="/plugins/export-data#devices" data-toggle="tab" aria-expanded="true">Device comparison</a></li>
                            <li><a href="/plugins/export-data#ports" data-toggle="tab">Port comparison</a></li>
                        </ul>
                    </div>
...
<script src="{{ asset('dmbokhan/export-data/js/requests.js') }}"></script>
